...
1. Next step was finding an arbitrary functions dependant on generator parametrization that would give me desired values for algorithm parameters.  1. Finally I troughoutly tested the parameter functions on many generator settings.   
